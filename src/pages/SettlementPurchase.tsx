...
export function SettlementPurchase() {
  ...
  const fetchData = async () => {
    const res = await api.settlement.purchase.list()
    setRecords(res.data || [])
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">采购付款</h1>
          <p className="text-gray-500 mt-1">管理采购订单付款</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <p className="text-sm text-gray-500">付款笔数</p>
